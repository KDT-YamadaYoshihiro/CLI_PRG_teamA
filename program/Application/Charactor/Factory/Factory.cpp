...
{
	// キャラクターデータの初期化
	m_characterData.emplace(static_cast<int>(Chara::ID::HERO), Chara::Status{ "勇者",				120,120,  38,  10, 12 });
	...
	m_characterData.emplace(static_cast<int>(Chara::ID::BOSS), Chara::Status{ "インフェルノウルフ",	 80, 80,  20,  15,  8});
}